...
public class Enemy {
	...
	public Enemy(Texture enemyTexture, ShotManager shotManager, AreYouAlive game) 
	{
	...
	private void spawn()
	{
		...
		animatedSprite.setPosition(xPosition, AreYouAlive.SCREEN_HEIGHT - animatedSprite.getHeight());
	...
	private int createRandomPosition() 
	{
		...
		int randomNumber = random.nextInt(AreYouAlive.SCREEN_WIDTH - animatedSprite.getWidth() + 1);
